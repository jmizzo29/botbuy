...
- Search/purchase: **category-agnostic** (cars, houses, software, domains, and broader) via pluggable marketplace adapters. Not a merchant allowlist. Intent default category = general (inferred). John templates: Anything (default), Car, House, Software / Domain / Official catalog scaffolds.
