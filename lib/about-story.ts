...
/** About captions follow Land E. Soft-signal HOLD. soft-spine mark is live sitewide. */
...
export const ABOUT_MARK_SRC = "/brand/logo-soft-spine/botbuyer-mark.svg" as const;
