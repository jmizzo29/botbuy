...
export const SEARCHING_EMPTY_BODY =
  "No live matches yet. Search is a HOLD stub — agent runtime is not live.";
export const SEARCHING_EMPTY_PRIMARY = GO_LIVE_PRIMARY_LABEL;
export const SEARCHING_EMPTY_PRIMARY_HREF = "/onboarding/go-live";
