...
export const HONESTY_SENT_FALSE = "sent=false" as const;
export const HONESTY_REGISTERED_FALSE = "registered=false" as const;
...
export const ACT_ON_BEHALF_STRUCTURAL_HONESTY = [
  HONESTY_LIVE_FALSE,
  HONESTY_SPEND_FALSE,
  HONESTY_SENT_FALSE,
  HONESTY_REGISTERED_FALSE,
  HONESTY_AUTO_APPROVE_FALSE,
  HONESTY_FAIL_CLOSED,
] as const;
...
export function actOnBehalfHonestyFlags(input: {
  keysConfigured: boolean;
  prepared?: boolean;
  ...
  return [
    ...
    honestyToken("prepared", input.prepared ?? false),
    honestyToken("keysConfigured", input.keysConfigured),
    honestyToken("mailKeysConfigured", input.mailKeysConfigured ?? false),
    honestyToken(
      "connectorKeysConfigured",
      input.connectorKeysConfigured ?? false,
    ),
    honestyToken("mutationsLiveEnabled", input.mutationsLiveEnabled ?? false),
    HONESTY_AUTO_APPROVE_FALSE,
    HONESTY_FAIL_CLOSED,
  ];
}
