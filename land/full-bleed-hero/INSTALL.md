...
- Overlay on the stage: soft-spine reverse lockup `/brand/logo-soft-spine/botbuyer-logo-header.svg` + **word link only** — **About** (visible on phone and desktop). No Private beta in the overlay. Sign in lives in the fold CTA cluster.
