...
- Top-of-screen = text links (light-on-navy). Logo may be the reverse lockup image. **No button / pill / chip** in the overlay nav.
...
- No light footer chrome band on land
...
- **Phone:** inverted arc in the upper field with air above; centered **22rem** copy + **full-width Sign up** + Install in the bottom gradient cap (white / muted on navy). H1 stays ~1 line on 390.
