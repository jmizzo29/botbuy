...
- No light header / banners. Full-bleed navy + overlay reverse lockup (`/brand/logo-eclipse-pass/botbuyer-logo-primary-dark-bg.svg`) + word links only (Private beta / About / Sign in). No pill chrome in the top row.
