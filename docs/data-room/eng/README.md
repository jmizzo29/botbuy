...
| Native | `apps/mobile` **M0 in flight** (dual-target iOS+Android). **BLOCK PWA-as-product.** **BLOCK prod store until smoke.** |
...
| [`expo-native.md`](expo-native.md) | `apps/mobile` M0 · stage/internal before store · PWA block |
