...
| 3 | Engineering | `docs/data-room/eng/` | **EXISTS** at tip `94407cc` (PR #92). Expo `apps/mobile/` tip still **pending**. |
...
| — | Expo native | `apps/mobile/` | **PENDING** — M0 in flight (`bc-2590ca55` / PR #93). No App Store/Play prod. |
...
- App Store / Play prod listing (Expo tip pending)  
