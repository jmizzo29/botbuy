...
For product questions during early access, email **legal@botbuyer.ai** with subject line starting `Product:` until a separate product inbox is provisioned — or use in-app flows when signed in.
...
**Also see:** [About](/about) · [Early access](/beta) · [Privacy](/privacy) · [Terms](/terms)
