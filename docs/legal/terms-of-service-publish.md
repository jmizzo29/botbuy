...
**Pricing:** Any subscription or success fees will be disclosed before you pay. Planning figures that may appear in internal docs are **not** live public pricing. **You will see any fees before you pay.**
...
We may modify, suspend, or discontinue features at any time during POC / early access.

---

## 3. Account; accuracy; credential security

You must provide accurate account information and keep it updated. You are responsible for:

- safeguarding login credentials and devices;
- all activity under your account unless you promptly notify us of unauthorized use;
- ensuring only authorized people act on the account (including deal approvals).

We may require human gates such as captcha, 2FA, bank gates, and KYC **when required**. Failure to complete required gates may limit or block use.
...
When a **subscription** and/or **success / Closed** fee is offered, fees will be **disclosed before you pay** (e.g., at signup or checkout). **You will see any fees before you pay.** Planned pricing is **NOT live**.

- Planned or internal pricing ranges may change and are **not** a live public price commitment in these Terms.
- No fee is owed under these Terms merely because a planning number was discussed internally or in product docs.
- We do **not** present early-access use as paid-user traction or launch metrics.

CHO gates public claims; these Terms do not authorize fake traction or live pricing claims.
...
## 8. Post-close operate agents

Buy+operate agents included post-close are **stubs / Demo · not live** unless a specific feature is clearly labeled otherwise in the product. These Terms do not promise live operate-agent performance, uptime, or outcomes.
...
**DRAFT — attorney must tune especially for payment losses and agent errors.**
...
## 16. Dispute resolution — **omitted until attorney supplies text**

> **Not operative.** This section does **not** set venue, arbitration, or court rules. No “courts in [Venue TBD]” (or similar) placeholder is part of these Terms.

Until counsel supplies dispute-resolution text, this clause is **omitted** from these Terms. No venue or arbitration rule is stated here.

---

## 17. Changes; contact; entire agreement

**Changes.** We may update these Terms. For material changes during or after POC, we will provide notice appropriate to the stage (site notice and/or email). Continued use after the effective date may constitute acceptance where permitted — counsel to tune.
...
**Contact:** legal@botbuyer.ai · https://botbuyer.ai/contact
