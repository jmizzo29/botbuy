...
For privacy questions, contact: **legal@botbuyer.ai** (if mail is not yet monitored, use [Contact](/contact)).
...
We do **not** use this to claim marketing uses (e.g., selling personal info for ads) that are not product intent. See Section 6.
...
- **Legal entity / operator:** Build Star Labs (Florida). Mailing address forthcoming.
